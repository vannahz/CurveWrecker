package hk.hku.cs.curvewrecker.Image3D;
...
/**
 * Created by vannahz on 2015/12/12.
 */
public class Image3DSwitchView extends ViewGroup {
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        image3DUtil.setmCurrentImage(mCurrentImage);
        //System.out.println(image3DUtil.getmCurrentImage());
    }
